  ...
  if (!loading && data.length === 0 && !userIsAdmin) {
    return (
      <NoAcess
        ...
        `}
        title={
          userIsAdmin ? "Няма намерени партньори" : "Нямате зачислени партньори"
        }
      />
    );
  }
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Сигурни ли сте, че искате да изтриете партньор{" "}
              {partnerToDelete?.name}? Това действие не може да бъде отменено.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
