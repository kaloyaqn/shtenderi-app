    ...
    <table className={`w-full border border-black mb-4 ${className}`}>
      <thead>
        <tr className="bg-gray-200">
          ...
          <th className="border border-black px-2 py-1">Баркод</th>
      ...
      <tbody>
        {missingProducts && missingProducts.length > 0 ? (
            ...
            return (
              <tr key={mp.id}>
                ...
                <td className="border border-black px-2 py-1 text-center">
                  <BarcodeVisualization barcode={mp.product?.barcode} />
                </td>
                <td className="border border-black px-2 py-1 text-center">
          ...
          <tr>
            <td colSpan="6" className="p-2 border text-center">Няма липсващи продукти.</td>
          </tr>
        )}
      </tbody>
      {showTotals && missingProducts && missingProducts.length > 0 && (
        <tfoot>
          <tr className="font-bold bg-gray-100">
            <td className="p-2 border text-right" colSpan={3}>Общо:</td>
