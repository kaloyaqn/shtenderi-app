...
export async function createPartner({
    ...
    // Use snake_case for price_group_id to match schema and Go API
    const data = {
        id: partnerId,
        name,
        bulstat,
    ...
    // Only set priceGroupId if provided (null/undefined is allowed)
...
export async function updatePartner(
    ...
    try {
        ...
        // Only include email if explicitly provided (avoid unknown arg on older clients)
