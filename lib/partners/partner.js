...
export async function createPartner({ id, name, bulstat, contactPerson, phone, address, mol, country, city }) {
    ...
    const partner = await prisma.partner.create({
        data: { id, name, bulstat, contactPerson, phone, address, mol, country, city },
    })
...
export async function updatePartner(partnerId, { name, bulstat, contactPerson, phone, address, mol, country, city }) {
    if (!name) {
    ...
    try {
        const partner = await prisma.partner.update({
            where: { id: partnerId },
            data: { name, bulstat, contactPerson, phone, address, mol, country, city },
        })
        return partner;
    } catch (error) {
