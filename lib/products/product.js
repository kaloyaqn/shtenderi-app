...
export async function createProduct({ name, invoiceName, barcode, pcode, clientPrice, deliveryPrice, pcd, image, quantity }) {
    ...
    return await prisma.product.create({
        data: { name, invoiceName, barcode, pcode: pcode || null, clientPrice, deliveryPrice, pcd, image: image || null, quantity: quantity || 0 }
    });
}
