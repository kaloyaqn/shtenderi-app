...
export class PartnerService extends BaseService {
  ...
  async createPartner(data) {
    const { id, name, bulstat, contactPerson, email, phone, address, mol, country, city, percentageDiscount, priceGroupId } = data;
  ...
  async updatePartner(partnerId, data) {
    const { name, bulstat, contactPerson, email, phone, address, mol, country, city, percentageDiscount, priceGroupId } = data;
